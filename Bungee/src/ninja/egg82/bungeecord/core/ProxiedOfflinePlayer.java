...
import ninja.egg82.bungeecord.reflection.redisBungee.IRedisBungeeHelper;
...
public class ProxiedOfflinePlayer {
    ...
    private IRedisBungeeHelper redisBungeeHelper = ServiceLocator.getService(IRedisBungeeHelper.class);
    ...
    public ProxiedOfflinePlayer(String name) {
        ...
        if (uuid == null && redisBungeeHelper != null) {
            uuid = redisBungeeHelper.getUuid(name.toLowerCase());
        }
        if (uuid == null) {
    ...
    public ProxiedOfflinePlayer(UUID uuid) {
        ...
        if (name == null && redisBungeeHelper != null) {
            name = redisBungeeHelper.getName(uuid);
        }
        if (name == null) {
