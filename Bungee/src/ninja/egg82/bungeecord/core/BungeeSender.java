...
public class BungeeSender extends AbstractSender {
	...
	public BungeeSender(CommandSender sender) {
		super(sender.getName(), (sender instanceof ProxiedPlayer) ? ((ProxiedPlayer) sender).getUniqueId() : new UUID(0L, 0L), !(sender instanceof ProxiedPlayer), !(sender instanceof ProxiedPlayer), sender);
		this.sender = sender;
	}
